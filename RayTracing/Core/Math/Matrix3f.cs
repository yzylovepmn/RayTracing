...
namespace RayTracing.Core
{
    ...
    public struct Matrix3f
    {
        ...
        public AxisAlignedBox3f Transform(AxisAlignedBox3f box)
        {
            ...
            var halfSize = new Vector3f(sizeX * Math.Abs(M11) + sizeY * Math.Abs(M21) + sizeZ * Math.Abs(M31),
                                        ...
                                        sizeX * Math.Abs(M13) + sizeY * Math.Abs(M23) + sizeZ * Math.Abs(M33));
            return new AxisAlignedBox3f(center, halfSize);
        }
        ...
        public bool HasInverse
        {
            ...
            {
                // temp hack
                return !MathUtil.IsZero((double)Determinant);
            }
        }
